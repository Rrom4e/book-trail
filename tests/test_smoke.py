...
from book_trail.cli import main
from book_trail.models import Note, ProjectState, Task
from book_trail.cli import demo_state
from book_trail.storage import load_state, save_state
from book_trail.models import generate_short_id
from book_trail.validation import normalize_tags, require_text, validate_task_status
from book_trail.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
